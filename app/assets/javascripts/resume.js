...
function displayBio() {
  var bio = {
    ...
    "about": "My background is primarily in psychology, but I have found a new passion in web developing.  In college, I majored in psychology and philosophy, and my honors thesis was on the cognitive and perceptual mechanics of error-detection during proofreading, which was integrated into a publication.  I went on to receive my Master's and my Special Integrative Project focused on mindfulness as a tool for facilitating posttraumatic growth.  In addition, I have  been working with a clinical services company that serves low-income, intellectually disabled individuals through not-for-profit community agencies in the New York City area.   I am an amateur headphone audiophile and collector, so it goes without saying that I love music.  I put together a small playlist below for you enjoyment; I often use this playlist while learning about programming and web development.   Additionaly, I am interested in computer hardware and have built two pcs and am in the process of building another one.  Other hardware projects include building a  router and wireless access points along with network-attached-storage from upcycled pc and server parts, which should be completed in the near future.",

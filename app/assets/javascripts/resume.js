...
function displayBio() {
  var bio = {
    ...
    "interests": "audiophile (headphones), music, PC Master Race(<a href='http://pcpartpicker.com/list/PQBbvV' class='pc-link' target='_blank'>Current Build</a>,<a href='http://pcpartpicker.com/list/8M8vFT' target='_blank' class='pc-link'>First Build</a>), writing, psychology, philosophy, reading, comedy, football, basketball, cooking",
